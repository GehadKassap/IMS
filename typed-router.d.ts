...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    'academic-year': RouteRecordInfo<'academic-year', '/academic-year', Record<never, never>, Record<never, never>>,
    ...
    'college': RouteRecordInfo<'college', '/college', Record<never, never>, Record<never, never>>,
